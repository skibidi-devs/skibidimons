...
TEST("Script_HasNoEffect control flow")
{
    ...
    EXPECT(Script_HasNoEffect(script, 0));
}
...
TEST("Script_HasNoEffect variables")
{
    ...
    EXPECT(!Script_HasNoEffect(setVariable, 0));
    EXPECT(!Script_HasNoEffect(addVariable, 0));
    EXPECT(!Script_HasNoEffect(subVariable, 0));
    EXPECT(!Script_HasNoEffect(copyVariable, 0));
    EXPECT(!Script_HasNoEffect(setorcopyVariable, 0));
    EXPECT(!Script_HasNoEffect(specialvarVariable, 0));
    EXPECT(!Script_HasNoEffect(getPlayerXYVariable1, 0));
